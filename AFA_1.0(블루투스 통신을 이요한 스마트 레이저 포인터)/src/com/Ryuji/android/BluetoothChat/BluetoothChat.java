...
public class BluetoothChat extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		FrameLayout fl = (FrameLayout)findViewById(R.id.TouchArea);
		...
		Button lbtn = (Button)findViewById(R.id.lbutton);
		...
		ImageButton timerBtn = (ImageButton) findViewById(R.id.timerBtn);
		...
		ImageButton mouseBtn = (ImageButton) findViewById(R.id.mouseBtn);
		mouseBtn.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				Intent myIntent = new Intent(getApplicationContext(),
						MouseActivity.class);
				sendMessage("C");
		...
		ImageButton centerBtn = (ImageButton) findViewById(R.id.centerbnt);
	...
	public void sendMessage(String message) {
		...
		if (message.length() > 0) {
			...
			//Toast.makeText(getApplicationContext(), message+"asd", Toast.LENGTH_LONG).show();
